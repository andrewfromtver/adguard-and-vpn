...
sed -i "s/ADGUARD_USERNAME/$ADGUARD_USERNAME/" ./.app_data/adguard/conf/AdGuardHome.yaml
sed -i "s/ADGUARD_PASSWORD_HASH/$ADGUARD_PASSWORD_HASH/" ./.app_data/adguard/conf/AdGuardHome.yaml

sed -i "s/NGINX_USERNAME/$NGINX_USERNAME/" ./.app_data/custompasswd/.htpasswd
sed -i "s/NGINX_PASSWORD_HASH/$NGINX_PASSWORD_HASH/" ./.app_data/custompasswd/.htpasswd

sed -i "s/ADGUARD_DNS_IP/$ADGUARD_DNS_IP/" ./.app_data/openvpn/conf/server.conf
sed -i "s/OPENVPN_SERVER_SUBNET/$OPENVPN_SERVER_SUBNET/" ./.app_data/openvpn/conf/server.conf
